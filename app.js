            ...
            if (name === key2) {
                swal({
                    ...
                    text: "Category : " + "( " + products[key][key2].category + " )  "
                        ...
                        + " --- Price : ( TK." + products[key][key2].price + " ) ",
                    textColor: "red",
                    imageUrl: src,
                    imageWidth: 300,
                    imageHeight: 250,
...
function insertData(id) {
    ...
    if (id === "watches") {
        ...
        var priceInfo = document.createElement("p");
        priceInfo.setAttribute("class", "proInfo");
        var priceText = document.createTextNode("Tk." + price);
        priceInfo.appendChild(priceText);
        mainDiv.appendChild(priceInfo);
...
function soldList() {
    ...
    for (var i = 0; i < b.length; i++) {
        ...
        var tpTdText = document.createTextNode("Tk." + TP);
    ...
    document.getElementById("saleTotal").innerHTML = "Tk." + tp;
}
soldList()
